% ------------------------------------------------------------------------
%> @brief Displays styled formatted text in the Command Window
%>
...
%>
%> @param format	The format of the output text
%>
%> @param varagrin	String definition and variables to print
%>
%> @retval cout		The printed output
%>
%> @par Example
